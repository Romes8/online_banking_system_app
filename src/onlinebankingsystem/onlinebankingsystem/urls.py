...
urlpatterns = [
    ...
    path('mysql/showCards/', views.show_cards, name='Show Cards'),
    path('mysql/showTransactions/', views.show_transactions, name='Show Transactions for the specific period'),
